...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-primary text-white hover:bg-primary-hover glow-effect",
        accent: "bg-accent text-background hover:bg-accent-hover glow-effect-accent",
        outline: "border border-border bg-transparent hover:bg-background-card",
        ghost: "hover:bg-background-card",
      },
      size: {
